...
?>
                                ...
                                ?>
                                            <a href="#" class="mx-1" onclick="showModal('<?=fullUrl(route_to('admin_route_edit_pickup', $shipping['id']))?>', '<?=lang('Site.edit_pickup')?>')" data-toggle="tooltip" title="<?=lang('Site.edit_pickup')?>"><i class='fas fa-pen'></i></a>
                                            <a href="#" id='mark_pickup_as_complete_<?=$shipping_id?>' class="mx-1" onclick="confirmModal('<?=fullUrl(route_to('admin_route_mark_pickup_as_complete', $shipping_id))?>', this.id, true, '', 'tr', 'btn-teal')" data-toggle="tooltip" title="<?=lang("Site.mark_pickup_as_completed")?>"><i class='fas fa-check text-success'></i></a>
                                <?php
