...
<div class="my-2">
    <form method="post" action="<?=base_url().route_to('admin_route_update_location')?>" id="edit_location_form">
        ...
        <div class="card-body">
                ...
                <div class="row">
                   <div class="col-12 col-md-2"> 
                    ...
                    <div class="col-12 col-md-10"> 
                        <input type="text" name="name" class="form-control" maxlength="255" placeholder="<?=lang('Site.name')?>" value="<?=$location['name']?>" required>
            ...
            <div class="form-group">
                <div class="row">
                   <div class="col-12 col-md-2"> 
                    ...
                    <div class="col-12 col-md-10"> 
                        <input type="text" name="zipcode" class="form-control" maxlength="255" placeholder="<?=lang('Site.zipcode')?>" value="<?=$location['zipcode']?>" required>
            ...
            <div class="form-group">
                <div class="row">
                   <div class="col-12 col-md-2"> 
                    ...
                    <div class="col-12 col-md-10"> 
                        <input class="form-control" name="pickup_only_price" type="number" step="0.01" placeholder="<?=lang("Site.pickup_only_price")?>" value="<?=$location['pickup_only_price']?>">
            ...
            <div class="form-group">
                <div class="row">
                   <div class="col-12 col-md-2"> 
                    ...
                    <div class="col-12 col-md-10"> 
                        <input class="form-control" name="delivery_only_price" type="number" step="0.01" placeholder="<?=lang("Site.delivery_only_price")?>" value="<?=$location['delivery_only_price']?>">
            ...
            <div class="form-group">
                <div class="row">
                   <div class="col-12 col-md-2"> 
                    ...
                    <div class="col-12 col-md-10"> 
                        <input class="form-control" name="pickup_delivery_price" type="number" step="0.01" placeholder="<?=lang("Site.pickup_delivery_price")?>" value="<?=$location['pickup_delivery_price']?>">
            ...
            <button type="submit" class="btn btn-primary btn-block mt-2" id="form-submit" onclick="submitForm('edit_location_form')"><?=lang("Site.save")?></button>
        </div>
    </form>
</div>
