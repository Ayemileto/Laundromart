    ...
    public function fetchItems()
    {
        ...
        foreach($pickups as $pickup)
        {
            ...
            $calendar[] = [
                ...
                'url'               => fullUrl(route_to('admin_route_order_details', $pickup['order_id'])),
        ...
        foreach($deliveries as $delivery)
        {
            ...
            $calendar[] = [
                ...
                'url'               => fullUrl(route_to('admin_route_order_details', $delivery['order_id'])),
